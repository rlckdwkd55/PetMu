...
<body>
    ...
    <script>
    	...
    	function post(){
	    	location.href = "<%= request.getContextPath() %>/insertView.bo?cate=5";
    	}
    	...
    	$('#sortList').on('change', function(){
    		...
    		case "new" : location.href = "<%= request.getContextPath()%>/selectList.bo?cate=5";
    					 break;
    		case "like" : location.href = "<%= request.getContextPath()%>/selectSortList.bo?cate=5&sort=" + sortL;
						   break;
    		case "cmt" : location.href = "<%= request.getContextPath()%>/selectSortList.bo?cate=5&sort=" + sortL;
			   			   break;
    		}
